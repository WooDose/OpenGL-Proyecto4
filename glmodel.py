...
scene = pyassimp.load('ARK_COFFEE_CUP.obj')

texture_surface = pygame.image.load('ark_coffee.png')
...
def createTheMatrix(counter,current_cam):
  translate = glm.translate(i, glm.vec3(0, 0, 0))
  rotate = glm.rotate(i, glm.radians(counter), glm.vec3(0, 1, 0))
  scale = glm.scale(i, glm.vec3(1, 1, 1))

  model = translate * rotate * scale
  view = glm.lookAt(current_cam, glm.vec3(0, 0, 0), glm.vec3(0, 1, 0))
